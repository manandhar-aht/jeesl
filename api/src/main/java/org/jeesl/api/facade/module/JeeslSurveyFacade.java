...
public interface JeeslSurveyFacade <L extends UtilsLang, D extends UtilsDescription,
	...
	extends UtilsFacade
{	
	TEMPLATE load(TEMPLATE template, boolean withQuestions, boolean withCells);
	...
	JsonFlatFigures surveyCountOption(SURVEY survey, List<QUESTION> questions);
	JsonFlatFigures surveyCountAnswer(SURVEY survey, List<QUESTION> questions);
}
