...
public class AbstractUtilsFacadeBean implements UtilsFacade
{
	...
	@Override public <L extends UtilsLang,D extends UtilsDescription, S extends EjbWithId,G extends UtilsGraphic<L,D,G,GT,GS>, GT extends UtilsStatus<GT,L,D>, GS extends UtilsStatus<GS,L,D>> S load(Class<S> cS, S status){return fUtils.load(cS,status);}
