					...
					implements JeeslTsRestExport
{
	...
	private final JeeslTsFacade<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,SAMPLE,USER,WS,QAF> fTs;
	
	private final Class<UNIT> cUnit;
	
	private TsRestService(JeeslTsFacade<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,SAMPLE,USER,WS,QAF> fTs,final Class<L> cL, final Class<D> cD, final Class<UNIT> cUnit)
	{
		super(fTs,cL,cD);
		this.fTs=fTs;
	...
	public static <L extends UtilsLang,
					...
					WS extends UtilsStatus<WS,L,D>,
					QAF extends UtilsStatus<QAF,L,D>>
			TsRestService<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,SAMPLE,USER,WS,QAF>
			factory(JeeslTsFacade<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,SAMPLE,USER,WS,QAF> fTs, final Class<L> cL, final Class<D> cD, final Class<UNIT> cUnit)
	{
		return new TsRestService<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,SAMPLE,USER,WS,QAF>(fTs,cL,cD,cUnit);
	}
