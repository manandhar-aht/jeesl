...
@EjbErNode(name="Category",category="io",subset="io",level=4)
public class IoTemplateCategory implements Serializable,EjbRemoveable,EjbPersistable,
							UtilsStatus<IoTemplateCategory,Lang,Description>
{
