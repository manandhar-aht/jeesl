...
@EjbErNode(name="Type",category="io",subset="io",level=4)
public class IoTemplateType implements Serializable,EjbRemoveable,EjbPersistable,
							UtilsStatus<IoTemplateType,Lang,Description>
{
	...
	@Override public boolean equals(Object object) {return (object instanceof IoTemplateType) ? id == ((IoTemplateType) object).getId() : (object == this);}
