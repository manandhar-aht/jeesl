...
@EjbErNode(name="Category",category="ts",subset="ts",level=3)
public class TsCategory implements Serializable,EjbRemoveable,EjbPersistable,
								UtilsStatus<TsCategory,AhtUtilsLang,AhtUtilsDescription>
{
	...
	{
        return (object instanceof TsCategory) ? id == ((TsCategory) object).getId() : (object == this);
    }
