...
@EjbErNode(name="Data Source",category="ts",subset="ts",level=4)
public class TsDataSource implements Serializable,EjbRemoveable,EjbPersistable,
							UtilsStatus<TsDataSource,Lang,Description>
{
