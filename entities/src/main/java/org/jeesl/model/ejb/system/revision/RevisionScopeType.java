...
public class RevisionScopeType implements Serializable,EjbRemoveable,EjbPersistable,
							UtilsStatus<RevisionScopeType,Lang,Description>
{
	...
	{
        return (object instanceof RevisionScopeType) ? id == ((RevisionScopeType) object).getId() : (object == this);
    }
