					...
					implements Serializable
{
	...
	public AbstractAdminTsScopeBean(final Class<L> cL, final Class<D> cD, final Class<CAT> cCategory, final Class<TRANSACTION> cTransaction, final Class<SOURCE> cSource)
	{
