								...
								QAF extends UtilsStatus<QAF,L,D>>
{
	...
	public static <L extends UtilsLang,
					...
					WS extends UtilsStatus<WS,L,D>,
					QAF extends UtilsStatus<QAF,L,D>>
	EjbTsClassFactory<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF> factory(final Class<EC> cEc)
	{
		return new EjbTsClassFactory<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF>(cEc);
	}
