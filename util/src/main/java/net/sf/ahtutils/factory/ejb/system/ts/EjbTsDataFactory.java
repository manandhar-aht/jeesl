								...
								QAF extends UtilsStatus<QAF,L,D>>
{
	...
	public static <L extends UtilsLang, D extends UtilsDescription,
					...
					WS extends UtilsStatus<WS,L,D>,
					QAF extends UtilsStatus<QAF,L,D>>
		EjbTsDataFactory<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF> factory(final Class<DATA> cData)
	{
	return new EjbTsDataFactory<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF>(cData);
	}
