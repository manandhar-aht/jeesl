											...
											QAF extends UtilsStatus<QAF,L,D>>
{
	...
	public static <L extends UtilsLang,
					...
					WS extends UtilsStatus<WS,L,D>,
					QAF extends UtilsStatus<QAF,L,D>>
	EjbTsScopeFactory<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF> factory(final Class<SCOPE> cScope)
	{
		return new EjbTsScopeFactory<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF>(cScope);
	}
