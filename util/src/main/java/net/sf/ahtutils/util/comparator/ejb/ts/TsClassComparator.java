								...
								QAF extends UtilsStatus<QAF,L,D>>
{
    ...
    public Comparator<EC> factory(Type type)
    {
        ...
        TsClassComparator<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF> factory = new TsClassComparator<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF>();
        switch (type)
        {
