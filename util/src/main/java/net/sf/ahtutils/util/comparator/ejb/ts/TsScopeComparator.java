								...
								QAF extends UtilsStatus<QAF,L,D>>
{
    ...
    public Comparator<SCOPE> factory(Type type)
    {
        ...
        TsScopeComparator<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF> factory = new TsScopeComparator<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF>();
        switch (type)
        {
