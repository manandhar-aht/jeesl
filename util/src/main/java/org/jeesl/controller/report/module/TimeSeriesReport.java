...
//implements JeeslReportHeader//,JeeslFlatReport,JeeslXlsReport
{
	...
	private final JeeslTsFacade<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF> fTs;
	...
	public TimeSeriesReport(String localeCode,
			...
			final JeeslTsFacade<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,WS,QAF> fTs,
