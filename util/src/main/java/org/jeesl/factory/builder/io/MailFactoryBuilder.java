...
public class MailFactoryBuilder<L extends UtilsLang,D extends UtilsDescription,
...
{
	final static Logger logger = LoggerFactory.getLogger(MailFactoryBuilder.class);
	...
	public MailFactoryBuilder(final Class<L> cL, final Class<D> cD, final Class<CATEGORY> cCategory, final Class<MAIL> cMail, final Class<STATUS> cStatus, final Class<RETENTION> cRetention)
	{
		super(cL,cD);
