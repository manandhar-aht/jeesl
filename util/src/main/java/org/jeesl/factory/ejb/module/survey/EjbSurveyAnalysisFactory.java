...
public class EjbSurveyAnalysisFactory<L extends UtilsLang, D extends UtilsDescription,
				...
				CORRELATION extends JeeslSurveyCorrelation<L,D,?,?,?,TEMPLATE,?,?,?,?,QUESTION,QE,SCORE,UNIT,ANSWER,MATRIX,DATA,OPTIONS,OPTION,CORRELATION>, DOMAIN extends JeeslSurveyDomain<L,D,DOMAIN,PATH,DENTITY,ANALYSIS,AQ,AT,ATT>,
