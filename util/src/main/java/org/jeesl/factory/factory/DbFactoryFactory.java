...
//	private final Class<STATUS> cStatus;
	...
	public DbFactoryFactory(final Class<L> cL,final Class<D> cD,final Class<DUMP> cDump, final Class<FILE> cFile, final Class<HOST> cHost, final Class<STATUS> cStatus)
	{       
		super(cL,cD);
        this.cDump = cDump;
        this.cFile = cFile;
