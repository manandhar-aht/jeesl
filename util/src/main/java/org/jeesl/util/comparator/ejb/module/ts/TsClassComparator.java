								...
								QAF extends UtilsStatus<QAF,L,D>>
{
    ...
    public Comparator<EC> factory(Type type)
    {
        ...
        TsClassComparator<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,SAMPLE,USER,WS,QAF> factory = new TsClassComparator<L,D,CAT,SCOPE,UNIT,TS,TRANSACTION,BRIDGE,EC,INT,DATA,SAMPLE,USER,WS,QAF>();
        switch (type)
        {
