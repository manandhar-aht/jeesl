...
public class IoReportCellComparator<L extends UtilsLang,D extends UtilsDescription,
								...
								ATTRIBUTE extends EjbWithId>
{
    ...
    public Comparator<CELL> factory(Type type)
    {
        ...
        IoReportCellComparator<L,D,CATEGORY,REPORT,IMPLEMENTATION,WORKBOOK,SHEET,GROUP,COLUMN,ROW,TEMPLATE,CELL,STYLE,CDT,CW,RT,ENTITY,ATTRIBUTE> factory = new IoReportCellComparator<L,D,CATEGORY,REPORT,IMPLEMENTATION,WORKBOOK,SHEET,GROUP,COLUMN,ROW,TEMPLATE,CELL,STYLE,CDT,CW,RT,ENTITY,ATTRIBUTE>();
        switch (type)
        {
