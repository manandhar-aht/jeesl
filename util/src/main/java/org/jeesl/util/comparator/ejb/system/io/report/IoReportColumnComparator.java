								...
								TRANSFORMATION extends UtilsStatus<TRANSFORMATION,L,D>>
{
    ...
    public Comparator<COLUMN> factory(Type type)
    {
        ...
        IoReportColumnComparator<L,D,CATEGORY,REPORT,WORKBOOK,SHEET,GROUP,COLUMN,FILLING,TRANSFORMATION> factory = new IoReportColumnComparator<L,D,CATEGORY,REPORT,WORKBOOK,SHEET,GROUP,COLUMN,FILLING,TRANSFORMATION>();
        switch (type)
        {
