								...
								TRANSFORMATION extends UtilsStatus<TRANSFORMATION,L,D>>
{
    ...
    public Comparator<SHEET> factory(Type type)
    {
        ...
        IoReportSheetComparator<L,D,CATEGORY,REPORT,IMPLEMENTATION,WORKBOOK,SHEET,GROUP,COLUMN,CDT,ENTITY,ATTRIBUTE,FILLING,TRANSFORMATION> factory = new IoReportSheetComparator<L,D,CATEGORY,REPORT,IMPLEMENTATION,WORKBOOK,SHEET,GROUP,COLUMN,CDT,ENTITY,ATTRIBUTE,FILLING,TRANSFORMATION>();
        switch (type)
        {
